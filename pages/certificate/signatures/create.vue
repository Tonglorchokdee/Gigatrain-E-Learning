                    ...
                    <v-container id="input-usage" fluid>
                        ...
                        <v-row class="form-row">
                            <v-col cols="3" class="text-right">
                                <label class="label-main">ชื่อลายเซ็นต์<span class="text-danger">*</span></label>
                            </v-col>
                            <v-col cols="7">
                        ...
                        <v-row class="form-row">
                            <v-col cols="3" class="text-right">
                                <label class="label-main"> ตำแหน่งงาน<span class="text-danger">*</span></label>
                            </v-col>
                            <v-col cols="7">
                                <v-text-field outlined dense>
                                </v-text-field>
                        ...
                        <v-row class="form-row">
                            <v-col cols="3" class="text-right">
                                <label class="label-main"> ไฟล์ภาพลายเซ็นต์</label>
                            </v-col>
                            <v-col cols="7">
                                <template>
