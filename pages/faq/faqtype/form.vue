...
<script>
import { uploadService, faqtypeService } from "@/plugins/api";
export default {
  name: "FormFaqtype",
  props: {
    id: Number,
      ...
      try {
        if (this.$refs.form.validate()) {
          if (this.form == "create") {
            ...
            if (await faqtypeService.create(params)) {
              this.$router.push({ name: "faq-faqtype" });
            } else {
            ...
            if (await faqtypeService.edit(params)) {
              this.$router.push({ name: "faq-faqtype" });
            }
          }
        }
